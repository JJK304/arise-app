...
export const SplashScreen = ({ rankColor }) => (
    <div style={{ position:"fixed", inset:0, zIndex:2000, background:"#050508", display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center", animation:"splashOut 0.4s ease 1.4s forwards", pointerEvents:"none" }}>    <div style={{ fontSize:"0.64rem", letterSpacing:"0.45em", color:"#475569", marginBottom:16, animation:"splashFade 0.4s ease 0.1s both" }}>SYSTEM NOTIFICATION</div>
    ...
    <div style={{ fontSize:"0.64rem", letterSpacing:"0.4em", color:"#475569", marginTop:8, animation:"splashFade 0.6s ease 0.3s both" }}>AWAKENING SYSTEM ONLINE</div>
